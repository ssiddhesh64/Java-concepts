 ...
 *
 * <p>WHY THIS WAS WRITTEN: - Exposes how compiler auto-unboxing of wrapper nulls causes unexpected
 * NullPointerExceptions.
 *
 * <p>KEY LESSONS: - Unboxing a null wrapper (e.g. Integer which is null into a primitive int)
 * throws NullPointerException. - Check for null before assigning wrappers to primitives.
 */
import java.util.*;
