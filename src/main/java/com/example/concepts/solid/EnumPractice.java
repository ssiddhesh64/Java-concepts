...
public class EnumPractice {
     ...
     *
     * <p>WHY THIS WAS WRITTEN: - Shows how to implement constant-specific behavior in Enums using
     * abstract methods.
     *
     * <p>KEY LESSONS: - Enums can declare abstract methods implemented by each constant. - Align
     * method visibility (e.g. public abstract) to prevent scope narrowing warnings.
     */
