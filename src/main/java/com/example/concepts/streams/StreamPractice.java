 ...
 *
 * <p>WHY THIS WAS WRITTEN: - Demonstrates clean, nested Optional mapping and average salary
 * calculations.
 *
 * <p>KEY LESSONS: - Use Optional.map() to safely navigate chains of nullable references. - Use
 * Objects::nonNull to filter stream nulls cleanly.
 */
import java.util.*;
...
public class StreamPractice {
    ...
    public static boolean checkList(Stream<String> strs) {
        return strs.anyMatch(
                str -> str != null && !str.isBlank() && str.startsWith("J") && str.length() > 5);
    }
    ...
    public static void main(String[] args) {
        ...
        User user1 = new User("1", new Profile("John", new Address("Mumbai", "400001")));

        User user2 = new User("2", new Profile("Jane", new Address("   ", "400002")));
    ...
    // Nested helper class to prevent namespace conflicts
    static record User(String id, Profile profile) {}

    // Nested helper class to prevent namespace conflicts
    static record Profile(String name, Address address) {}

    // Nested helper class to prevent namespace conflicts
    static record Address(String city, String zipCode) {}
}
