 ...
 *
 * <p>WHY THIS WAS WRITTEN: - Demonstrates how to group stream elements by a property into a Map.
 *
 * <p>KEY LESSONS: - Collectors.groupingBy() splits a stream into buckets. - Downstream collectors
 * can perform aggregations (like counting or averaging) within each bucket.
 */
