 ...
 *
 * <p>WHY THIS WAS WRITTEN: - Shows how to chain, combine, and handle errors in async pipelines.
 *
 * <p>KEY LESSONS: - Use thenCombine() to combine the results of two independent futures. - Use
 * exceptionally() at the end of the pipeline to catch all intermediate errors.
 */
