 ...
 *
 * <p>WHY THIS WAS WRITTEN: - Shows how to chain multiple sort parameters in a declarative manner.
 *
 * <p>KEY LESSONS: - Comparator.comparing() and thenComparing() chain sort orders. - Use
 * Comparator.reverseOrder() or reversed() for descending sorts.
 */
...
public class ComparatorExample {
    ...
    static Comparator<Employee> cmp =
