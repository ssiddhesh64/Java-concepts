 ...
 *
 * <p>WHY THIS WAS WRITTEN: - Shows how mutating objects stored in a HashSet leads to duplicate
 * entries or elements getting 'lost'.
 *
 * <p>KEY LESSONS: - HashMap/HashSet keys must be immutable. - If an object's fields change, its
 * hashCode changes, making it impossible to find in its bucket.
 */
import java.util.*;
